...
<div id="content" className="content">
        <h1 id="main_header"><p>&nbsp;</p> -TOWN NAME- Community Engagement with Blockchain Project: Community_inPUT<p>&nbsp;</p></h1>
        <h2>Town of -TOWN NAME- and Tufts University's Department of Urban and Environmental Policy and Planning</h2>
        
        <div id="desc">
        <p>&nbsp;</p>
        <h2>Why Care? How Does it Work?</h2>
        <div id="desc_text">
            This website is a web3 application, utilizing blockchain to facilitate dicussions surrounding accesory dwelling units in the town of -TOWN NAME- Massachusetts. Using metamask, people can pariticpate 
            in complex conversations, have their responses recorded on a ledger, and maintain their anonymity. 
        </div>
        <p>&nbsp;</p>
        </div>
        <p>&nbsp;</p>
        <h2 >What do you think are the major housing-related issues, challenges, or problems in -TOWN NAME-?</h2>
        ...
        <h2>
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <h2>How do you think we should address or solve these housing issues in -TOWN NAME-?</h2>
        <h2 id="answers">Answers</h2>
        <table className="table">
          <thead>
            <tr>
